...
public class AttachmentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        try {
            ...
            attachmentInfo = LocalStore.getLocalInstance(account, getContext()).getAttachmentInfo(id);
    ...
    private String getType(String dbName, String id, String format, String mimeType) {
        ...
        if (FORMAT_THUMBNAIL.equals(format)) {
            ...
            try {
                final LocalStore localStore = LocalStore.getLocalInstance(account, getContext());
